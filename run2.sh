...
function setPostgresPassword() {
    ...
    sudo -u postgres psql -c "ALTER USER renderer WITH SUPERUSER"
...
if [ ! -f /data.osm.pbf ]; then
    ...
    wget -nv http://download.geofabrik.de/europe/malta-latest.osm.pbf -O /data.osm.pbf
    wget -nv http://download.geofabrik.de/europe/malta.poly -O /data.poly
fi
